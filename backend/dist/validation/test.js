...
const TestValidation = joi_1.default.object({
    ...
    language: (0, GlobalValidation_1.selectValidator)("Test language", constants_1.TEST_LANGUAGES, true),
    level: (0, GlobalValidation_1.selectValidator)("Test Level", constants_1.TEST_LEVELS, true),
});
